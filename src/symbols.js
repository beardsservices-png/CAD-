...
export const SYMBOLS = [
  ...
  // ---- Lumber ---------------------------------------------------------------
  // Boards place LENGTHWISE at 8 ft — the long side, as you'd see it looking
  // down on a board lying flat. Drag an end to change the length, drag a side
  // to switch flat/on-edge, or use the rotate grip to stand it vertical.
  // Posts place as plan-view squares (that's what a post looks like from above);
  // rotate/stretch them for an elevation view.
  { id: "2x4", name: "2×4 (8 ft)", category: "Lumber", w: 96, h: 3.5, label: "2×4",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, ...grain("h")] },
  { id: "2x6", name: "2×6 (8 ft)", category: "Lumber", w: 96, h: 5.5, label: "2×6",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, ...grain("h")] },
  { id: "2x8", name: "2×8 (8 ft)", category: "Lumber", w: 96, h: 7.25, label: "2×8",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, ...grain("h")] },
  { id: "2x10", name: "2×10 (8 ft)", category: "Lumber", w: 96, h: 9.25, label: "2×10",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, ...grain("h")] },
  { id: "2x12", name: "2×12 (8 ft)", category: "Lumber", w: 96, h: 11.25, label: "2×12",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, ...grain("h")] },
  { id: "2x4edge", name: "2×4 on edge", category: "Lumber", w: 96, h: 1.5, label: "2×4",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, ...grain("h")] },
  { id: "2x8edge", name: "2×8 joist (on edge)", category: "Lumber", w: 96, h: 1.5, label: "2×8",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, ...grain("h")] },
  { id: "2x10edge", name: "2×10 joist (on edge)", category: "Lumber", w: 96, h: 1.5, label: "2×10",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, ...grain("h")] },
  { id: "1x6", name: "1×6 Board (8 ft)", category: "Lumber", w: 96, h: 5.5, label: "1×6",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, ...grain("h")] },
  { id: "deckpt", name: "5/4×6 Deck (PT, 8 ft)", category: "Lumber", w: 96, h: 5.5, label: "5/4 PT", color: "#3f7d20",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, ...grain("h")] },
  { id: "4x4", name: "4×4 Post (plan)", category: "Lumber", w: 3.5, h: 3.5, label: "4×4",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, { t: "line", x1: 0, y1: 0, x2: 1, y2: 1 }, { t: "line", x1: 1, y1: 0, x2: 0, y2: 1 }] },
  { id: "6x6", name: "6×6 Post (plan)", category: "Lumber", w: 5.5, h: 5.5, label: "6×6",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, { t: "line", x1: 0, y1: 0, x2: 1, y2: 1 }, { t: "line", x1: 1, y1: 0, x2: 0, y2: 1 }] },
  { id: "4x4pt", name: "4×4 Post (PT, plan)", category: "Lumber", w: 3.5, h: 3.5, label: "4×4 PT", color: "#3f7d20",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, { t: "line", x1: 0, y1: 0, x2: 1, y2: 1 }, { t: "line", x1: 1, y1: 0, x2: 0, y2: 1 }] },
  { id: "6x6pt", name: "6×6 Post (PT, plan)", category: "Lumber", w: 5.5, h: 5.5, label: "6×6 PT", color: "#3f7d20",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, { t: "line", x1: 0, y1: 0, x2: 1, y2: 1 }, { t: "line", x1: 1, y1: 0, x2: 0, y2: 1 }] },
  { id: "4x4elev", name: "4×4 Post (elevation)", category: "Lumber", w: 3.5, h: 96, label: "4×4", color: "#3f7d20",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, ...grain("v")] },
  { id: "6x6elev", name: "6×6 Post (elevation)", category: "Lumber", w: 5.5, h: 96, label: "6×6", color: "#3f7d20",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, ...grain("v")] },
  ...
  // ---- Metal roof trim & flashing (10 ft stock lengths) ----------------------
  { id: "dripedge", name: "Drip Edge / Eave Trim", category: "Roofing", w: 120, h: 3, label: "Drip edge", color: "#64748b",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, { t: "line", x1: 0, y1: 0.65, x2: 1, y2: 0.65 }] },
  { id: "raketrim", name: "Rake / Gable Trim", category: "Roofing", w: 120, h: 4, label: "Rake trim", color: "#64748b",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, { t: "line", x1: 0, y1: 0.5, x2: 1, y2: 0.5 }] },
  { id: "fasciametal", name: "Fascia Metal", category: "Roofing", w: 120, h: 6, label: "Fascia metal", color: "#94a3b8",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, { t: "line", x1: 0, y1: 0.75, x2: 1, y2: 0.75 }] },
  { id: "headwall", name: "Headwall / Apron Flashing", category: "Roofing", w: 120, h: 8, label: "Headwall flash", color: "#64748b",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, { t: "line", x1: 0, y1: 0.45, x2: 1, y2: 0.45 }] },
  { id: "sidewall", name: "Sidewall / Step Flashing", category: "Roofing", w: 120, h: 6, label: "Sidewall flash", color: "#64748b",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, ...stripes("v", 8)] },
  { id: "kickout", name: "Kickout Flashing", category: "Roofing", w: 6, h: 8, label: "Kickout", color: "#0891b2",
    prims: [{ t: "poly", closed: true, pts: [[0, 0], [1, 0], [1, 0.6], [0.35, 1], [0, 1]] },
            { t: "line", x1: 0.35, y1: 1, x2: 1, y2: 0.6 }] },
  { id: "closureout", name: "Outside Closure Strip", category: "Roofing", w: 36, h: 1.5, label: "Outside closure", color: "#a855f7",
    prims: [{ t: "line", x1: 0, y1: 1, x2: 1, y2: 1 },
            { t: "arc", cx: 0.14, cy: 1, r: 0.5, a0: Math.PI, a1: 0 },
            { t: "arc", cx: 0.5, cy: 1, r: 0.5, a0: Math.PI, a1: 0 },
            { t: "arc", cx: 0.86, cy: 1, r: 0.5, a0: Math.PI, a1: 0 }] },
  { id: "closurein", name: "Inside Closure Strip", category: "Roofing", w: 36, h: 1.5, label: "Inside closure", color: "#a855f7",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 },
            { t: "arc", cx: 0.14, cy: 1, r: 0.5, a0: Math.PI, a1: 0 },
            { t: "arc", cx: 0.5, cy: 1, r: 0.5, a0: Math.PI, a1: 0 },
            { t: "arc", cx: 0.86, cy: 1, r: 0.5, a0: Math.PI, a1: 0 }] },
  { id: "gutterguard", name: "Gutter Guard", category: "Roofing", w: 48, h: 5, label: "Gutter guard", color: "#0f766e",
    prims: [{ t: "rect", x: 0, y: 0, w: 1, h: 1 }, ...stripes("v", 12)] },
  { id: "dselbow", name: "Downspout Elbow", category: "Roofing", w: 6, h: 8, label: "DS elbow", color: "#94a3b8",
    prims: [{ t: "poly", pts: [[0.25, 0], [0.25, 0.55], [1, 0.9]] },
            { t: "poly", pts: [[0.75, 0], [0.75, 0.35], [1, 0.45]] }] },
  { id: "dsstrap", name: "Downspout Strap", category: "Roofing", w: 6, h: 1.5, label: "DS strap", color: "#94a3b8",
    prims: [{ t: "rect", x: 0.2, y: 0, w: 0.6, h: 1 },
            { t: "line", x1: 0, y1: 0.5, x2: 0.2, y2: 0.5 }, { t: "line", x1: 0.8, y1: 0.5, x2: 1, y2: 0.5 }] },
